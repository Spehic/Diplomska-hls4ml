...
myproject_axi_mux_104_16_1_1 #(
    ...
    .din10_WIDTH( 4 ),
    .dout_WIDTH( 16 ))
myproject_axi_mux_104_16_1_1_U2775(
    .din0(tmp_data_V_0),
    .din1(tmp_data_V_1),
    .din2(tmp_data_V_2),
    .din3(tmp_data_V_3),
...
myproject_axi_lshr_32ns_32ns_32_2_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
myproject_axi_lshr_32ns_32ns_32_2_1_U2776(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_437_p0),
...
myproject_axi_shl_64ns_32ns_64_2_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
myproject_axi_shl_64ns_32ns_64_2_1_U2777(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_445_p0),
    .din1(grp_fu_445_p1),
...
always @ (posedge ap_clk) begin
    if (((icmp_ln935_reg_578 == 1'd0) & (1'b1 == ap_CS_fsm_state9))) begin
        ...
        tmp_435_reg_684 <= m_2_fu_463_p2[32'd25];
    end
end
...
assign p_Result_35_fu_514_p5 = {{m_6_fu_494_p1[63:32]}, {tmp_1029_i_fu_507_p3}, {m_6_fu_494_p1[22:0]}};
...
assign select_ln964_fu_487_p3 = ((tmp_435_reg_684[0:0] === 1'b1) ? 8'd127 : 8'd126);
...
assign tmp_1029_i_fu_507_p3 = {{p_Result_33_reg_567}, {add_ln964_fu_502_p2}};

assign tmp_434_fu_381_p3 = lsb_index_reg_618[32'd31];
...
assign xor_ln949_fu_388_p2 = (tmp_434_fu_381_p3 ^ 1'd1);

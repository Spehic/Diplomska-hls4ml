...
reg    line_buffer_Array_V_1332_0_ce0;
reg    line_buffer_Array_V_1332_0_we0;
wire   [15:0] line_buffer_Array_V_1332_0_q0;
reg   [0:0] ap_NS_fsm;
...
always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        line_buffer_Array_V_1332_0_ce0 = 1'd1;
    end else begin
        line_buffer_Array_V_1332_0_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        line_buffer_Array_V_1332_0_we0 = 1'd1;
    end else begin
        line_buffer_Array_V_1332_0_we0 = 1'b0;
    end
end
...
assign ap_return_4 = line_buffer_Array_V_1332_0_q0;

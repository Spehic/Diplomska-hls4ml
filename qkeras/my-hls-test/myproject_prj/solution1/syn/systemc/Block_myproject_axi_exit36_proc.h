...
#ifndef _Block_myproject_axi_exit36_proc_HH_
#define _Block_myproject_axi_exit36_proc_HH_
...
struct Block_myproject_axi_exit36_proc : public sc_module {
    ...
    sc_out< sc_lv<16> > tmp_data_V_914;
    sc_out< sc_logic > tmp_data_V_914_ap_vld;


    // Module declarations
    Block_myproject_axi_exit36_proc(sc_module_name name);
    SC_HAS_PROCESS(Block_myproject_axi_exit36_proc);
    ...
    sc_signal< sc_lv<16> > tmp_data_V_914_preg;
    ...
    void thread_tmp_data_V_914();
    void thread_tmp_data_V_914_ap_vld();

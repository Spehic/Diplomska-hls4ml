...
entity Block_myproject_axi_exit36_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Block_myproject_axi_exit36_proc is 
    ...
    signal tmp_data_V_914_preg : STD_LOGIC_VECTOR (15 downto 0) := "0000000000000000";
...
begin
    ...
    tmp_data_V_914_preg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    tmp_data_V_914_preg <= out_local_V_data_9_V_dout;
                end if; 
            end if;
        end if;
    end process;
    ...
    tmp_data_V_914_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, out_local_V_data_9_V_dout, io_acc_block_signal_op12, tmp_data_V_914_preg)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            tmp_data_V_914 <= out_local_V_data_9_V_dout;
        else 
            tmp_data_V_914 <= tmp_data_V_914_preg;
        end if; 
    end process;


    tmp_data_V_914_ap_vld_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, io_acc_block_signal_op12)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (io_acc_block_signal_op12 = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 

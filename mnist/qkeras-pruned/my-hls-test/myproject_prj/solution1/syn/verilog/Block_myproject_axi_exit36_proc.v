...
module Block_myproject_axi_exit36_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [15:0] tmp_data_V_914;
output   tmp_data_V_914_ap_vld;
...
reg[15:0] tmp_data_V_914;
reg tmp_data_V_914_ap_vld;
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (io_acc_block_signal_op12 == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_data_V_914_ap_vld = 1'b1;
    end else begin
        tmp_data_V_914_ap_vld = 1'b0;
    end
end
...
endmodule //Block_myproject_axi_exit36_proc

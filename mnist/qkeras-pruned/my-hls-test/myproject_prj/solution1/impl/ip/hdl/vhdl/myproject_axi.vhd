...
architecture behav of myproject_axi is 
    ...
    signal Loop_1_proc404_U0_ap_start : STD_LOGIC;
    signal Loop_1_proc404_U0_ap_done : STD_LOGIC;
    signal Loop_1_proc404_U0_ap_continue : STD_LOGIC;
    signal Loop_1_proc404_U0_ap_idle : STD_LOGIC;
    signal Loop_1_proc404_U0_ap_ready : STD_LOGIC;
    signal Loop_1_proc404_U0_start_out : STD_LOGIC;
    signal Loop_1_proc404_U0_start_write : STD_LOGIC;
    signal Loop_1_proc404_U0_in_r_TREADY : STD_LOGIC;
    signal Loop_1_proc404_U0_in_local_V_data_0_V_din : STD_LOGIC_VECTOR (15 downto 0);
    signal Loop_1_proc404_U0_in_local_V_data_0_V_write : STD_LOGIC;
    signal Loop_1_proc404_U0_ap_return : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal myproject_U0_qconv2d_1_input_V_data_V_read : STD_LOGIC;
    ...
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_0 : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_0_ap_vld : STD_LOGIC;
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_1 : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_1_ap_vld : STD_LOGIC;
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_2 : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_2_ap_vld : STD_LOGIC;
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_3 : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_3_ap_vld : STD_LOGIC;
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_4 : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_4_ap_vld : STD_LOGIC;
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_5 : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_5_ap_vld : STD_LOGIC;
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_6 : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_6_ap_vld : STD_LOGIC;
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_7 : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_7_ap_vld : STD_LOGIC;
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_8 : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_8_ap_vld : STD_LOGIC;
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_914 : STD_LOGIC_VECTOR (15 downto 0);
    signal Block_myproject_axi_exit36_proc_U0_tmp_data_V_914_ap_vld : STD_LOGIC;
    signal ap_channel_done_tmp_data_V_914 : STD_LOGIC;
    signal tmp_data_V_914_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_tmp_data_V_914 : STD_LOGIC := '0';
    signal ap_sync_channel_write_tmp_data_V_914 : STD_LOGIC;
    ...
    signal tmp_data_V_914_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_data_V_914_empty_n : STD_LOGIC;
    ...
    port (
        ...
        tmp_data_V_914 : OUT STD_LOGIC_VECTOR (15 downto 0);
        tmp_data_V_914_ap_vld : OUT STD_LOGIC );
    end component;
    ...
    port (
        ...
        tmp_data_V_914 : IN STD_LOGIC_VECTOR (15 downto 0) );
    end component;
...
begin
    Loop_1_proc404_U0 : component Loop_1_proc404
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    in_local_V_data_0_V_U : component fifo_w16_d784_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    out_local_V_data_0_V_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_1_V_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_2_V_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_3_V_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_4_V_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_5_V_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_6_V_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_7_V_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_8_V_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    out_local_V_data_9_V_U : component fifo_w16_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    tmp_data_V_914_U : component fifo_w16_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_channel_write_tmp_data_V_914_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
    ...
    ap_channel_done_tmp_data_V_914 <= ((ap_sync_reg_channel_write_tmp_data_V_914 xor ap_const_logic_1) and Block_myproject_axi_exit36_proc_U0_ap_done);
    ...
    ap_sync_channel_write_tmp_data_V_914 <= ((tmp_data_V_914_full_n and ap_channel_done_tmp_data_V_914) or ap_sync_reg_channel_write_tmp_data_V_914);
